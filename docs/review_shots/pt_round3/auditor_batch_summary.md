...
## Auditor conflict fix (2026-09-21)
- `pt_gloria_v1` `total_pkg`：優先數 Packing details **Shipping unit** 唯一列（需同時有已知 Carton/Pallet 等 type summary，以免破壞 soft-missing）。
- 修正：50666881 2→**3**；50666882 1→**2**；50659168 6→**24**。soft-missing（Packaging／Standard pallet 等）仍為 None。
